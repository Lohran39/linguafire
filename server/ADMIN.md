...
Os dados usam as APIs existentes. Não há migração SQL nesta mudança. Falhas de cada fonte são sinalizadas separadamente. Se uma atualização falhar, os dados anteriores ficam visíveis com o aviso de falha. A fila carrega até 100 denúncias antigas; ao atingir o limite, a visão geral mostra “100 ou mais”. A lista de revisados depende do limite existente de até 1.000 itens por tipo.

Consumo de tokens, incidentes de provedores, resultados da avaliação da IA, plano por aluno e métricas financeiras ainda precisam de integração. Não são exibidos números demonstrativos nem estados de saúde presumidos.
