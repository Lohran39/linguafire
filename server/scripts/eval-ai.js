...
const suite = [...cases, ...require('../evals/pedagogy-cases'), ...require('../evals/multiturn-cases')];
...
async function main() {
  if (process.env.AI_EVAL_LIVE !== '1') throw new Error(`Set AI_EVAL_LIVE=1 to run ${suite.length} synthetic cases; retries may add requests.`);
